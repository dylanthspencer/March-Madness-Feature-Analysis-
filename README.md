...
- **Week 5** – Determine the data we want and find data sources to scrape from — *Dylan and Harri*
...
- **Week 9** – Develop our first model and plots for analysis — *Dylan*

- **Week 10** – Finalize analysis, interpret results, and prepare final presentation — *Dylan and Harri*
